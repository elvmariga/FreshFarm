...
//              $email = md5($email);
              ...
              $stmt->bind_result($ID_no, $first_name,$last_name, $email, $pass_to_store,  $phone_no, $location, $date);
...
//              }
             ...
             if($email==null){
                 ...
                 if(password_verify($farmer_password,$pass_to_store)){
                    ...
                    echo '<div class="alert alert-danger alert-dismissible fade show w-100"> Password
                          <button class="close" role="button" data-dismiss="alert" aria-label="close"><span aria-hidden="true">&times;</span></button>
                      </div>';
                 }
...
<head>
    ...
    <title>FreshFarm | Farmer log_in</title>
...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    ...
    <div class="container pl-20px">
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            ...
            <a class="btn btn-secondary btn-lg" href="farmer-registration.php" role="button">Create Account</a>
...
<div class="container">
    <div class="row text-center">
        ...
        <div class="form-group">
            ...
            <input type="password" class="form-control" id="InputPassword" name="farmer_password" placeholder=" EnterPassword">
        </div>
        <div class="log">
